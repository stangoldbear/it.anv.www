...
**Non-negotiable rules:**
- Page content MUST reside in MDX files within the `src/pages/` directory structure
...
Tests MUST be written for business-critical components and utility functions.
